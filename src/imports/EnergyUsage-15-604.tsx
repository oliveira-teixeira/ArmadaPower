import svgPaths from "./svg-iywn0d7y82";
...
function TapAWeek() {
  return (
    <div className="absolute bg-[#284271] content-stretch flex inset-[47.45%_1.4%_45.92%_0.28%] items-center justify-center pb-[6px] pl-[89px] pr-[88px] pt-[7px] rounded-[8px]" data-name="Tap a week">
      ...
      <p className="font-['Roboto:SemiBold','Noto_Sans:SemiBold',sans-serif] font-semibold leading-[16px] relative shrink-0 text-[#cad6ec] text-[10.24px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function BackgroundBorder2() {
  return (
    <button className="bg-[#183d64] content-stretch cursor-pointer flex flex-col h-[36px] items-center p-[9px] relative rounded-[8px] shrink-0" data-name="Background+Border">
      <div aria-hidden="true" className="absolute border border-[#7695cf] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#cad6ec] text-[12.8px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex gap-[8px] inset-[20.92%_87.13%_69.9%_0.05%] items-center">
      <BackgroundBorder1 />
      <BackgroundBorder2 />
      <BackgroundBorder3 />
      <BackgroundBorder4 />
