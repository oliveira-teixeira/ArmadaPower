import svgPaths from "./svg-0th1o3logy";
...
function Paragraph1() {
  return (
    <div className="content-stretch flex items-center opacity-70 relative shrink-0 w-full" data-name="Paragraph">
  ...
  return (
    <div className="h-[886px] relative shrink-0 w-full z-[2]" data-name="Main">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-start pb-[196.62px] pt-[36px] px-[20px] relative size-full">
          <Frame1 />
          <Container5 />
          <Container6 />
