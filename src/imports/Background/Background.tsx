import svgPaths from "./svg-xmbwjz5q3z";
  ...
  return (
    <div className="bg-[#0a1a2e] content-stretch flex h-[40px] items-center justify-between px-[12px] py-[4px] relative rounded-[8px] shrink-0 w-[320px]" data-name="Input">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic opacity-80 relative shrink-0 text-[#cad6ec] text-[14px] whitespace-nowrap">
        <p className="leading-[24px]">Create a password</p>
      </div>
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Lucide Icons">
        <div className="absolute inset-[8.33%]" data-name="Vector">
          <div className="absolute inset-[-5%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.0009 22">
              <path d={svgPaths.p7e53e80} id="Vector" stroke="var(--stroke-0, #4B75C0)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
...
function Input1() {
  return (
    <div className="bg-[#0a1a2e] content-stretch flex gap-[8px] h-[40px] items-center px-[12px] py-[4px] relative rounded-[8px] shrink-0 w-[102px]" data-name="Input">
      <div aria-hidden="true" className="absolute border border-[#cad6ec] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] opacity-80 relative shrink-0 text-[#cad6ec] text-[12.8px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Container() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-0 overflow-clip p-[24px] right-0 top-[64px]" data-name="Container">
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold h-[16px] justify-center leading-[0] relative shrink-0 text-[#0a111d] text-[12.8px] w-[335px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[20px]">Account details</p>
      </div>
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold h-[30px] justify-center leading-[0] min-w-full relative shrink-0 text-[#f7f9fc] text-[25px] w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[36px]">General information</p>
      </div>
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[320px]" data-name="Field">
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#f7f9fc] text-[14px] w-[min-content]">
      ...
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[320px]" data-name="Field">
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#f7f9fc] text-[14px] w-[min-content]">
          <p className="leading-none">Email address</p>
        </div>
        <div className="bg-[#0a1a2e] content-stretch flex flex-col h-[40px] items-start justify-center px-[12px] py-[4px] relative rounded-[8px] shrink-0 w-[320px]" data-name="Input">
          <div aria-hidden="true" className="absolute border border-[#cad6ec] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] opacity-80 relative shrink-0 text-[#cad6ec] text-[12.8px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[20px]">Johndoe@email.com</p>
          </div>
        </div>
      </div>
      <Field />
...
function FixedFooter() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col items-center justify-center left-0 pb-[48px] pt-[21px] right-0" data-name="Fixed Footer">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.08)] border-solid border-t inset-0 pointer-events-none" />
      <div className="bg-[#4b75c0] min-w-[80px] relative rounded-[8px] shrink-0 w-[311px]" data-name="Button">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center min-w-[inherit] overflow-clip px-[12px] py-[8px] relative rounded-[inherit] w-full">
          <Wrap />
        </div>
      </div>
    </div>
...
export default function Background() {
  return (
    <div className="bg-[#0a111d] relative size-full" data-name="Background">
      <Header />
      <Container />
      <FixedFooter />
    </div>
