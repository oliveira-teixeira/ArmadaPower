import svgPaths from "./svg-kszri74akz";
          ...
          <div className="absolute inset-1/4" data-name="Vector">
            <div className="absolute inset-[-6.25%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
                <path d={svgPaths.p2e230080} id="Vector" stroke="var(--stroke-0, #D29F00)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
...
function AlertsOptionalStateExamples() {
  return (
    <div className="bg-[#ffeeb8] relative rounded-[8px] shrink-0 w-full" data-name="Alerts (Optional state examples)">
      ...
      <div className="content-stretch flex flex-col gap-[12px] items-start pb-[17px] pt-[9px] px-[17px] relative w-full">
        <Frame1 />
        <Frame3 />
      </div>
    </div>
...
function Container11() {
  return (
    <div className="content-stretch flex flex-col h-[73px] items-start opacity-90 relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic opacity-70 relative text-[#f7f9fc] text-[13px] w-full whitespace-pre-wrap">
